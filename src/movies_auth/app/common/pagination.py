...
def get_pagination_params(default_page_size: int | None = None) -> tuple[int, int]:
    default_pagesize = default_page_size or app_settings.PAGINATOR.page_size
    page_size = request.args.get(app_settings.PAGINATOR.page_size_query_path) or default_pagesize
    page_number = request.args.get(app_settings.PAGINATOR.page_number_query_path) or 1
